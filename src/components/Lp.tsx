...
const Lp = () => {
    const [wscreen, setWscreen] = useState<number | null>(null); // Usar estado para armazenar a largura da janela

    const router = useRouter();

    useEffect(() => {
        const handleResize = () => {
            setWscreen(window.innerWidth); // Atualiza a largura da janela no estado
        };
    ...
    return (
        <div>
            {/* <div className="flex justify-end">
                <button className="bg-blue-500 rounded-lg text-white text-sm px-6 py-1">
                    Já é cliente?
                </button>
            </div> */}
                ...
                <div id="hero" className="flex w-full max-w-[90%] xl:max-w-[60%] mx-auto">
                    <div className="flex flex-col items-center lg:items-start text-center lg:text-left lg:w-[50%] md:pt-28">
                        ...
                        <div className="pl-2">
                            ...
                            <button onClick={() => {router.push('/checkout')}} className="mt-10 bg-blueDefault border-b-4 border-[#2F5397] w-80 lg:w-96 py-2 rounded-3xl ">
            ...
            <div id="economy" className="w-full text-center pb-12 flex flex-col items-center bg-[#FFFFFF]">
                ...
                {wscreen && wscreen > 700 ? (
                    <Image
                        className="mt-12 px-4 md:mx-0"
                        src="https://clubpump.com.br/wp-content/uploads/2022/09/como-funciona2.png"
                        alt="Imagem Desktop"
                        width={800}
                        height={500}
                    />
                    ...
                    <Image
                        className="mt-12 px-4 md:mx-0"
                        src="https://clubpump.com.br/wp-content/uploads/2022/09/desconto-sup-mobile3.jpg"
                        alt="Imagem Mobile"
                        width={400}
                        height={500}
                    />
            ...
            <div id="cashback" className="w-full bg-[#EAEAEA] px-8 py-12">
                <div className="w-full lg:max-w-[60%] mx-auto bg-white md:h-40 flex items-center justify-center">
                    <Image
                        src={wscreen && wscreen > 700 ? "https://clubpump.com.br/wp-content/uploads/2022/09/numerosdesconto.png" : "https://clubpump.com.br/wp-content/uploads/2022/09/numerosdesconto02.png"}
                        alt="Imagem de Números"
                        width={800}
                        height={10}
                    />
                </div>
            ...
            <div id="sobre" className="w-full bg-black p-10 md:p-16 text-white">
                <div className="flex flex-col lg:flex-row mx-auto gap-3 items-center">
                    <div className="flex w-[90%] lg:w-[50%] justify-end">
                        <Image src={"https://clubpump.com.br/wp-content/uploads/2022/08/quadro3.jpg"} alt="Imagem Sobre" width={550} height={10} />
                    </div>
                    <div className="w-full lg:w-[50%]">
                        <div className="text-center md:text-left max-w-[550px]">
                            ...
                            <button onClick={() => {router.push('/checkout')}} className="mt-10 bg-blueDefault border-b-4 border-[#2F5397] w-72 md:w-96 py-2 rounded-3xl ">
                                <span className="font-semibold text-lg">QUERO SER PREMIUM</span>
                            </button>
                        </div>
                    </div>
